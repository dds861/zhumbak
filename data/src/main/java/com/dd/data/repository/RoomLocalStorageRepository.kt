...
import com.dd.data.db.ZhumbakDatabase
...
class RoomLocalStorageRepository(
    ...
    val db: ZhumbakDatabase by lazy {
        val build = Room.databaseBuilder(
            context.applicationContext,
            ZhumbakDatabase::class.java,
            BuildConfig.DB_NAME
        )
...
//        build.fallbackToDestructiveMigration()
    ...
    override fun getRandomZhumbak(): ResponseZhumbakModel {
        return db.zhumbakDao().getRandomZhumbak().toDomainModel()
    }
}